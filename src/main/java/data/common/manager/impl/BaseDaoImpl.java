...
/*	@Qualifier("sessionFactory")
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <T> List<T> findBySql(String sql, String countStr, Map<String, Object> params, PageInfo pageInfo, Class clazz) {
    ...
    public int executeQueryParams(QueryParams queryParams) {
        ...
        if (queryParams instanceof HqlQueryParams) {
            if (params == null) {
                result = this.executeHql(query);
            } else {
                result = this.executeHql(query, params);
            }
